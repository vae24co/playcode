$(function () {
  ...
  var chart = new ApexCharts(
    document.querySelector("#Development_income"),
    options
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#social_marketing"),
    options
  );
  chart.render();
  ...
  new ApexCharts(
    document.querySelector("#sales_department"),
    options1
  ).render();
  ...
  var chart = new ApexCharts(document.querySelector("#seo_dep"), options);
  chart.render();
  ...
  var chart = new ApexCharts(document.querySelector("#visit_by"), options);
  chart.render();
  ...
  var options = {
    ...
    colors: ["#35cd3a", "#f79647", "#4aacc7", "#9bbb58", "#c0504e"],
    plotOptions: {
      pie: {
        donut: {
          size: "80%",
