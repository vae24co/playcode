(function ($) {
    ...
    $.fn.mauGallery.methods = {
        createRowWrapper(element) { if (!element.children().first().hasClass('row')) { element.append('<div class="gallery-items-row row g-4"></div>') } }, wrapItemInColumn(element, columns) {
            if (columns.constructor === Number) { element.wrap(`<div class='item-column col-${Math.ceil(12 / columns)}'><a href="#"></a></div>`) } else if (columns.constructor === Object) {
                ...
                element.wrap(`<div class='item-column ${columnClasses}'><a href="#"></a></div>`)
